...
USER_SETTINGS = {}  # user_id: {language, balance, total_deposited, total_spent, api_key, api_host}
BOT_USERNAME = ""
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    if user_id not in USER_SETTINGS:
        USER_SETTINGS[user_id] = {"language": "en", "balance": 0.0, "total_deposited": 0.0, "total_spent": 0.0}
